...
public:
  ...
  void initializeAtUniformRandomDirected(unsigned int particlesNb); //[Sol]
  ...
  double gyroYawForUniformDirectedReset; //[Sol] [deg]
  double directedResetNoiseTheta; //[Sol] [deg]
