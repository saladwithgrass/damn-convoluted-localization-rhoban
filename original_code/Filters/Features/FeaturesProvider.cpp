...
void FeaturesProvider::clearBalls()
{
    ball_positions.clear();
}
void FeaturesProvider::clearGoals()
{
    poi_positions.clear();
}
void FeaturesProvider::clearRobots()
{
...
void FeaturesProvider::pushGoal(const cv::Point2f& img_pos)
{
  hl_monitoring::Field::POIType type = hl_monitoring::Field::POIType::PostBase;
  poi_positions[type].push_back(img_pos);
}
