...
protected:
	void initFromEllipse(cv::Point_<T> axis, cv::Point_<T> centre, T a, T b)
	{
		if ((a<1)||(b<1))
		{
			throw std::runtime_error("Ill conicSection.initFromEllipse: a<1 or b<1");
		}	
		...
		if ((A >= 10000)||(B >= 10000)||(C >= 10000)||(D >= 10000)||(E >= 10000)||(F >= 10000))
		{
			throw std::runtime_error("Ill conicSection.initFromEllipse");
		}
...
#endif // __CONIC_SECTION_H__print a2
