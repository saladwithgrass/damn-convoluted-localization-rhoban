...
#define FBPRINT_DEBUG(str...) if (debug_output) { printf("[WHITE LINES] "); printf(str); }
...
void WhiteLinesData::computeTransformations(Vision::Utils::CameraState * cs, bool final_compute) {
  world_lines.clear();
  self_lines.clear();
