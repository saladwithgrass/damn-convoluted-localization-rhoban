...
void WhiteLines::get_plane_equation(double x1, double y1, double z1, 
...
void WhiteLines::process() 
{
  ...
  get_plane_equation(ls_pim0.x, ls_pim0.y, dx0+3,  ls_pim1.x, ls_pim1.y, dx1+3,  ls_pim2.x, ls_pim2.y, dx2+3, &planex_a, &planex_b, &planex_c, &planex_d);
  get_plane_equation(ls_pim0.x, ls_pim0.y, dy0+3,  ls_pim1.x, ls_pim1.y, dy1+3,  ls_pim2.x, ls_pim2.y, dy2+3, &planey_a, &planey_b, &planey_c, &planey_d);
